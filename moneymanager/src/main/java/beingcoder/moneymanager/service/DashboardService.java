...
import beingcoder.moneymanager.dto.RecentTransactionDTO;
...
public class DashboardService {
    ...
    public Map<String, Object> getDashboardData() { // no usages
        ProfileEntity profile = profileService.getCurrentProfile();
        Map<String, Object> returnValue = new LinkedHashMap<>();
        List<IncomeDTO> latestIncomes = incomeService.getLatest5IncomesForCurrentUser();
        List<ExpenseDTO> latestExpenses = expenseService.getLatest5ExpensesForCurrentUser();
        // Convert to unified RecentTransactionDTO
        List<RecentTransactionDTO> recentTransactions = Stream.concat(
                ...
                .sorted((a, b) -> { // sort by date descending, then createdAt descending
                ...
                .limit(5) // keep only latest 5 combined
